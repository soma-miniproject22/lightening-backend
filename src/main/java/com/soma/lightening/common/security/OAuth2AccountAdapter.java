...
// authentication.getPrincipal() 로 OAuth2AccountAdapter 가져올 수 있음
public class OAuth2AccountAdapter extends User {
    private OAuth2Account account;

    public OAuth2AccountAdapter(OAuth2Account account) {
